...
import { A, Marginale, ResolveAsset } from "../deps.ts";
import { Img } from "../deps.ts";
...
import { Alj, AE } from "./macros.tsx";

export function Page(props: PageTemplateProps & { children?: Expressions; name: string}): Expression {
  return <Dir name={props.name}>
...
export function PageTemplate(
  { htmlTitle, htmlDescription, headingId, heading, children, status, statusDate, toc }: PageTemplateProps & {
        ...
        <Html5
          ...
          headContents={
            <>
              ...
              <Meta name="description" content={htmlDescription ? <exps x={htmlDescription}/> : "Protocols for synchronisable data stores. The best parts? Fine-grained permissions, a keen approach to privacy, destructive edits, and a dainty bandwidth and memory footprint."}/>
              <Script>let FF_FOUC_FIX;</Script>{/*to prevent Firefox FOUC, this must be here*/}
              <Link rel="alternate" type="application/rss+xml" href="/rss_news.xml" title="Willow News and Updates"/>
              <Link rel="alternate" type="application/rss+xml" href="/rss_changelog.xml" title="Willow Specification Changelog"/>
        ...
        >
          ...
          <Div id="wrapContent">
            <Main>
              <Hsection title={<exps x={heading}/>} n={headingId}>
                {toc ? <TableOfContents stopLevel={99} /> : ""}   
                {
                  status
                  ? <P>
                    <RenderSpecStatus status={status}/>
                    {" "}{statusDate ? <>(as of <exps x={statusDate}/>)</> : ""}
                  </P> 
                  : ""}                     
                <exps x={children} />
              </Hsection>
            ...
            <Footer>
              <Nav>
                <Ul>
                  <Li><R n="willow">Home</R></Li>
                  <Li><R n="specifications">Specs</R></Li>
                  <Li><R n="news">News</R></Li>
                  <Li><R n="about">About Us</R></Li>
                  <Li><R n="projects_and_communities">Active Projects</R></Li>
                  <Li><R n="more">More</R></Li>
                </Ul>
              </Nav>
              ...
              <Div>
                ...
                <Marginale inlineable>
                  <A href="https://www.tu.berlin/" clazz="funder">
                    <Img
                      src={<ResolveAsset asset={["graphics", "tu_berlin.svg"]} />}
                      alt="The logo of the TU Berlin."
                    />
                  </A>
                </Marginale>
                <P>
                  <R n="aljoscha"/> has been employed at <AE href="https://www.tu.berlin/">TU Berlin</AE> while working on Willow.
                </P>
