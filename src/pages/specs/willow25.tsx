      ...
      >
        ...
        <Hsection n="willow25_defaults" title="Default Values">
          ...
          <P>
            ...
            <Code>
              [150, 211, 76, 84, 120, 69, 130, 49, 227, 100, 118, 121, 82, 170,
              234, 2, 163, 29, 34, 3, 198, 111, 67, 101, 105, 46, 249, 31, 53,
              16, 104, 210]
            </Code>.
          </P>
          ...
          <P>
            and whose <R n="mcat_sig" /> is the correct signature<Marginale>
              That signature is{" "}
              <Code>
                [42, 201, 58, 210, 193, 63, 237, 182, 150, 52, 93, 186, 198,
                231, 18, 84, 233, 156, 180, 68, 229, 232, 27, 145, 111, 202, 8,
                120, 240, 168, 169, 147, 43, 209, 164, 232, 70, 225, 202, 131,
                55, 123, 116, 10, 41, 184, 87, 10, 133, 3, 141, 80, 102, 43,
                168, 175, 102, 229, 104, 60, 147, 82, 20, 1]
              </Code>.
            </Marginale>{" "}
            for{" "}
            <Code>
