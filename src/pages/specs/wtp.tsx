      ...
      >
        ...
        <Hsection n="wtp_intro" title="Introduction">
          <PreviewScope>
            ...
            <P>
              ...
              <R n="D3Range" />, and it can request metadata for a purely{" "}
              <R n="wtp_client" />-driven{" "}
              <R n="d3_range_based_set_reconciliation">
                range-based set reconciliation
              </R>. The <R n="wtp_server" />{" "}
        ...
        <Hsection n="wtp_protocol" title="Protocol">
          ...
          >
            ...
            <P>
              There are two different kinds of requests, and two different kinds
              of request-specific responses. The responses each consist of the
              {" "}
              <R n="wtp_request_id" />{" "}
                    ...
                    },
                    {
                      ...
                      comment: (
                        <>
                          ...
                          <R n="wtp_client" />{" "}
                          to bring it up to speed with any newer data the{" "}
                          <R n="wtp_client" />{" "}
                          might have. The mechanism by which the{" "}
                          <R n="wtp_client" />{" "}
                          might deliver such data is left unspecified.
                        </>
                      ),
                    },
                    {
