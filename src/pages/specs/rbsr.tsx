...
export const rbsr = (
  <Dir name="rbsr">
    ...
    hsection("d3rbsr_parameters", "Fingerprinting", [
      ...
      pinformative("First, we require a function ", def_parameter_fn({id: "d3rbsr_fp_singleton", singular: "fingerprint_singleton"}), " that hashes individual ", rs("LengthyEntry"), " into the set ", r("d3rbsr_prefp"), ". This hash function should take into account all aspects of the ",  r("LengthyEntry"), ": modifying its ", r("entry_namespace_id"), ", <R n="entry_subspace_id"/>, <R n="entry_path"/>, <R n="entry_timestamp"/>, <R n="entry_payload_digest"/>, <R n="entry_payload_length"/>, or its number of ", r("lengthy_entry_available"), " bytes, should result in a completely different ", r("d3rbsr_prefp"), "."),
