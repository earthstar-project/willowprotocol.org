  ...
  <Dir name="3dstorage">
    ...
    hsection("d3storage_multidimensions", "Multidimensional Data Structures", [
        ...
        lis(
            ...
            [
                "A more simplistic option is to maintain three one-dimensional search trees of the same <R n="Entry"/> set, each using different linearisations of the three dimensions: one sorts by ", r("entry_subspace_id"), " first, using <Rs n="entry_path"/> as tiebreakers, and using <Rs n="entry_timestamp"/> as final tiebreaker; the next tree has <Rs n="entry_path"/> first, <Rs n="entry_timestamp"/> second, ", r("entry_subspace_id"), " third; the final tree has <Rs n="entry_timestamp"/> first, ", r("entry_subspace_id"), " second, <Rs n="entry_path"/> third. This technique is often used by ", link("RDF triple stores", "https://en.wikipedia.org/wiki/Triplestore"), ", for example by the Rya ", sidenote("store", [link(`Punnoose, Roshan, Adina Crainiceanu, and David Rapp. "Rya: a scalable RDF triple store for the clouds." Proceedings of the 1st International Workshop on Cloud Intelligence. 2012.`, "https://www.csd.uoc.gr/~hy561/papers/storageaccess/largescale/Rya-%20A%20Scalable%20RDF%20Triple%20Store%20for%20the%20Clouds.pdf")]), ".",
            ],
            [
