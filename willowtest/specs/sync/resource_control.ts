  ...
  [
    ...
    hsection("resources_data_handles", "Data Handles", [
      ...
      hsection("handles_resource_control", "Resource Control", [
        pinformative(
          "Adding handle-to-value bindings to local mappings requires space, so the ",
          r("handle_server"),
          " should have a way to throttle the ",
          r("handle_client"),
          ". We use a (superficially) simple solution: for each ",
          r("handle_type"),
          ", the messages for ",
          r("handle_bind", "binding"),
          " new ",
          rs("resource_handle"),
          " are sent over their own ",
          r("logical_channel"),
          ". Throttling that ",
          r("logical_channel"),
        ...
        pinformative(
          ...
          " a ",
          r("resource_handle"),
          " and moving this message to a message buffer does not mean that the ",
          r("resource_handle"),
          " has actually been ",
          r("handle_bind", "bound"),
          ". In fact, there might not be enough memory available to ",
          r("handle_bind"),
          " the ",
          r("resource_handle"),
          ", so the message has to sit in the message buffer, unprocessed. The ",
          r("handle_server"),
          " should strive to allocate buffer space only for messages whose ",
          rs("resource_handle"),
          " can be ",
          r("handle_bind", "bound"),
          " immediately, but this might not always be possible.",
        ),
        ...
        pinformative(
          ...
          " sends a ",
          def(
            { id: "handle_confirmation", singular: "confirmation" },
            "confirmation",
            [
              "A ",
              def_fake("handle_confirmation", "confirmation"),
              " message lets the ",
              r("handle_server"),
              " notify the ",
              r("handle_client"),
          ...
          " whenever it actually ",
          r("handle_bind", "binds"),
          " a ",
          r("resource_handle"),
          ". Several such ",
          rs("handle_confirmation"),
          " for ",
          rs("resource_handle"),
          " of the same ",
          r("handle_type"),
          " can be aggregated into a single ",
          r("handle_confirmation"),
          " message that specifies the ",
          r("handle_type"),
          " in question and the number of ",
          r("handle_bind", "bound"),
          " ",
          rs("resource_handle"),
          ". After receiving a ",
          ...
          ", the ",
          r("handle_client"),
          " knows it is safe to refer to the ",
          r("resource_handle", "resource handle(s)"),
          " in future messages.",
        ),
        ...
        pinformative(
          "If the ",
          r("handle_client"),
          " always had to wait for ",
          r("handle_confirmation"),
          " before using a ",
          r("resource_handle"),
          " in future messages, this would introduce additional latency. Hence, we allow ",
          rs("handle_client"),
          " to send messages that refer to ",
          rs("resource_handle"),
          ...
          " that it has not yet ",
          r("handle_bind", "bound"),
          ", it must drop this message and all future messages that refer to this ",
          r("resource_handle"),
          " or any newer ",
          rs("resource_handle", "handles"),
          " of the same ",
          r("handle_type", "type"),
          ", until it receives an ",
          def(
            { id: "handle_apology", singular: "apology", plural: "apologies" },
            "apology",
            [
              "An ",
              def_fake("handle_apology", "apology"),
              " message from the ",
              r("handle_client"),
              " informs the ",
              r("handle_server"),
              " to stop dropping messages containing ",
              rs("resource_handle"),
              " greater than and of the same ",
              r("handle_type", "type"),
              " as the ",
              r("resource_handle"),
              " specified in the ",
          ...
          " message for this ",
          r("handle_type"),
          ". It must also inform the ",
          r("handle_client"),
          " that it has started to drop messages for this ",
          r("handle_type"),
          ", and this message includes the numeric ",
          r("resource_handle", "handle"),
          " that caused the dropping.",
        ),

        pinformative(
          "While dropping messages that contain ",
          rs("resource_handle"),
          " that are too large, the ",
          r("handle_server"),
          " still continues to process messages that contain smaller ",
          rs("resource_handle", "handles"),
          " of the same ",
          r("handle_type"),
          ". If such a message contains a ",
          em("smaller"),
          " ",
          r("resource_handle"),
          " that is ",
        ...
        pseudocode(
            ...
            fields: [
              ...
              },
              {
                ...
                comment: [
                  ...
                  ") or not (",
                  code("false"),
                  "). This is needed for symmetric protocols where peers act as both ",
                  r("handle_client"),
                  " and ",
                  r("handle_server"),
                  " simultaneously and ",
          ...
          new Struct({
            ...
            comment: [
              "The ",
              r("handle_server"),
              " confirms that it has successfully processed the ",
              r("HandleConfirmNumber"),
              " oldest ",
              r("HandleBind"),
              " messages with ",
              r("handle_type"),
          ...
          new Struct({
            ...
            comment: [
              ...
              " notifies the ",
              r("handle_client"),
              " that it has started dropping messages that refer to ",
              rs("resource_handle"),
              " greater than or equal to ",
              r("HandleStartedDroppingAt"),
              " and will continue to do so until it receives an ",
              r("HandleApology"),
              " message.",
            ],
            fields: [
          ...
          new Struct({
            ...
            comment: [
              ...
              " notifies the ",
              r("handle_server"),
              " that it can stop dropping messages that refer to ",
              rs("resource_handle"),
              " greater than or equal to ",
              r("HandleApologyAt"),
              ". Note that the ",
              ...
              " ",
              r("HandleApologyType"),
              ") for which it has sent a ",
              r("HandleStartedDropping"),
              " message.",
            ],
            fields: [
              {
      ...
      hsection("delta_handles", "Delta Handles", [
        pinformative(
          "When encoding ",
          rs("resource_handle"),
          " as part of a message, we can do better than simply encoding their numeric values. After a ",
          r("resource_handle"),
          " has been ",
          r("handle_free", "freed"),
          ", we know that its value will never be communicated again. Instead of transmitting actual numeric values, we can instead transmit the difference between the numeric value and the numeric value of the oldest ",
          r("resource_handle"),
          " that has not yet been ",
          r("handle_free", "freed"),
          ". This way, we transmit smaller numbers, which can be encoded more efficiently. More precisely:",
        ),
