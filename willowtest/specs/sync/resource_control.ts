...
export const resource_control: Expression = site_template(
  ...
  [
    ...
    hsection("resouce_control_requirements", "Requirements", [
      ...
      figure(
        img(asset("resource_control/logical_channels.png"), "A sequence of boxes in four different colours on the left, the result of dividing them up by colour on the right. The one yellow box is missing on the right side."),
