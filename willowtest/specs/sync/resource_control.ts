  ...
  [
    ...
    hsection("resource_control_overview", "Solution Overview", [
      ...
      pinformative(
        ...
        r("logical_channel"),
        " and the number of ", rs("guarantee"), " the ",
        r("resources_server"),
        " would like the ", r("resources_client"), " to keep. Upon receiving this request, the ",
        r("resources_client"),
        " ",
      ...
      pseudocode(
        ...
        new Struct({
          ...
          comment: [
            ...
            " message such that the client’s remaining ", rs("guarantee"), " will be ",
