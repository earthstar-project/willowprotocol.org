import { def, def_fake, preview_scope } from "../../../defref.ts";
import { p } from "../../../h.ts";
...
export const resource_control: Expression = site_template(
    ...
    [
        ...
        p("Every ", def({ id: "logical_channel", singular: "logical channel"}, "logical channel", ["This tooltip was defined explicitly, rather than using the containing preview scope for the preview contents. It is the definition of a ", def_fake({ id: "logical_channel", singular: "logical channel"}, "logical channel"), "."]), " is fun"),
