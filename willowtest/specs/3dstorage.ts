...
// The second constraint is compatibility with the [range-based set reconciliation](https://arxiv.org/pdf/2212.13567.pdf) approach. All of these trees are easily extended to summarise the required monoid metadata. For the true multi-dimensional approaches (k-d trees and R-trees), the monoid must be commutative, but that's fine.
