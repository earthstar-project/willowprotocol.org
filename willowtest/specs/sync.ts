        ...
        hsection("sync_protocol", "Protocol", [
            ...
            hsection("sync_encodings", "Encodings", [
                ...
                ols(
                    ...
                    [r("RangeFingerprint"), " 2 + 2 + 1 + 1 (3dRange relative to previous range or contaniing Area), (special case empty fingerprint)"],
                    [r("RangeEntries"), " 2 + 2 + 2 + 1 + 1 + 1 (3dRange relative to previous range or contaniing Area)"],
