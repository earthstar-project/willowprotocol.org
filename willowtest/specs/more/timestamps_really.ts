...
export const timestamps_really: Expression = site_template(
    ...
    [
        pinformative("Willow implements a key-value store (up to prefix-based overwrites), and a key-value store can map any one key to at most one value. Willow uses simple numeric ", rs("Timestamp"), " to resolve conflicting mappings. This design decision might trigger some healthy skepticism, so this text walks you through our reasoning for building them into the protocol."),
