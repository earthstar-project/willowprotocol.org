...
title: "Three-Dimensional Data Storage",
    ...
    hsection("3dstorage_requirements", "Requirements", [
        ...
        pinformative("As for the requirements of syncing, we shall use the ", link_name("sync", "WGPS"), " as a (somewhat demanding) baseline. The WGPS needs to compute ", rs("Fingerprint"), " for arbitrary ", rs("3dRange"), ", to split arbitrary ", rs("3dRange"), " into multiple, roughly equally-sized subranges, and to constrain ", rs("Area"), " to a number of newest ", rs("Entry"), " (to work with ", rs("AreaOfInterest"), ")."),
