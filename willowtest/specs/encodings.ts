  ...
  hsection("specific_encodings", "Specific Encodings", [
    ...
    hsection("encodings_data_model", "Data Model Encodings", [
      ...
      pinformative(
        ...
        ". We can represent the length of any ",
        r("Path"),
        " component in ",
        r("path_length_power"),
        " bytes. ",
      ...
      pinformative(
        ...
        ". We can represent the number of components of any ",
        r("Path"),
        " in ",
        r("path_count_power"),
        " bytes. ",
      ...
      pinformative(
        ...
        lis(
          ...
          [
            ...
            lis(
              [
                "the length of the component, encoded as an unsigned, big-endian ",
                r("path_length_power"),
                "-byte integer, followed by the bytes of the component.",
              ],
            ),
          ],
        ),
